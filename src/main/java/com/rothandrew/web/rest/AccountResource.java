package com.rothandrew.web.rest;

import com.rothandrew.domain.User;
import com.rothandrew.service.InvalidPasswordException;
import com.rothandrew.service.MailService;
import com.rothandrew.service.UserService;
import com.rothandrew.service.UsernameAlreadyUsedException;
import com.rothandrew.service.dto.PasswordChangeDTO;
import com.rothandrew.service.dto.UserDTO;
import com.rothandrew.web.rest.errors.EmailAlreadyUsedException;
import com.rothandrew.web.rest.errors.EmailNotFoundException;
import com.rothandrew.web.rest.errors.LoginAlreadyUsedException;
import com.rothandrew.web.rest.vm.KeyAndPasswordVM;
import com.rothandrew.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.rothandrew.service.EmailAlreadyUsedException e) {
